...
class SDE(abc.ABC):
  ...
  def reverse(self, score_fn, score_fn_f, probability_flow=False):
    ...
    class RSDE(self.__class__):
      ...
      def sde(self, feature, x, flags, t, is_main, is_adj=True):
      ...
      def discretize(self, feature, x, flags, t, is_main, is_adj=True):
